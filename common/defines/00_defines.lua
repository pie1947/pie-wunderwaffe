...
NCountry = {
	...
	POPULATION_YEARLY_GROWTH_BASE = 0.012,			-- basic population growth per year, used for monthly manpower gain
	...
	MAX_PROPAGANDA_STABILITY_IMPACT = -0.1,			-- Max total penalty from operative performing the propaganda mission in a country
	MAX_PROPAGANDA_WAR_SUPPORT_IMPACT = -0.1,		-- Max total penalty from operative performing the propaganda mission in a country
	PROPAGANDA_STABILITY_DAILY_DECAY = 0.005,		-- Amount of stability recovered daily from propaganda effort
	PROPAGANDA_WAR_SUPPORT_DAILY_DECAY = 0.005,		-- Amount of war support recovered daily from war support effort
...
NResistance = {
	...
	RESISTANCE_TARGET_MODIFIER_OCCUPIED_IS_EXILE_MAX = 5.0,

	RESISTANCE_TARGET_MODIFIER_POP_LOW = -5.0,			-- how much we reduce the resistance target
	RESISTANCE_TARGET_MODIFIER_POP_VERY_LOW = -10.0,			-- resistance target modifier in % for states we have claim

	RESISTANCE_POP_LOW_CUTOFF = 100000,
	RESISTANCE_POP_VERY_LOW_CUTOFF = 250000,
	...
	COMPLIANCE_GROWTH_HAS_CLAIM = 15, -- compliance growth buff if state has a claim
	...
	GARRISON_STR_POW_MANPOWER = 1.4,	--Scales impact of manpower deficiency by raising that deficiency to the number here. Formula: efficiency = 1.0 - manpower_deficiency^GARRISON_STR_POW_MANPOWER
	GARRISON_STR_POW_EQUIPMENT = 1.4,	--Scales impact of euqipment deficiency by raising that deficiency to the number here. Formula: efficiency = 1.0 - equipment_deficiency^GARRISON_STR_POW_EQUIPMENT
	...
	SUPPRESSION_NEEDED_UPPER_CAP = 40.0, -- if resistance is greater than this value then we always act as though it is at the define for the purpose of suppresion requirements
...
NProduction = {
	...
	ANNEX_FUEL_RATIO = 0.75,	-- How much fuel will be transferred on annexation
	...
	MIN_FIELD_TO_TRAINING_MANPOWER_RATIO = 0.25,	-- Ratio which % of army in field can be trained
	CAPITULATE_STOCKPILES_RATIO = 0.75, -- How much equipment from deployed divisions will be transferred on capitulation
	CAPITULATE_FUEL_RATIO = 0.75, -- How much fuel will be transferred on capitulation
	...
	CIC_BANK_SPEED_BOOST_FACTOR = 0.5,                 -- The CIC bank can boost production speed with this factor (0.5 means 50 %)
	...
	LICENSE_EQUIPMENT_TECH_SPEED_MAX_YEARS = 1,			-- Maximum years for MIC speed modifier
	...
	MINIMUM_NUMBER_OF_FACTORIES_TAKEN_BY_CONSUMER_GOODS_PERCENT = 0.02,	-- The minimum number of factories we have to put on consumer goods, in percent.
},
...
NMarket = {
	...
	LOW_PRICE_LEVEL_FACTOR = 0.875,                    				-- The factor of base equipment price for low price level. Should be in range (0,1] 
	HIGH_PRICE_LEVEL_FACTOR = 1.375,                    				-- The factor of base equipment price for high price level. Should be more than 1.
...
NTechnology = {
	...
	MAX_TECH_SHARING_BONUS = 0.25, 			-- Max technology sharing bonus that can be applied instantly
...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 15.0,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
...
NMilitary = {
	...
	MAX_FIELD_EXPERIENCE_ON_DIVISION = 80000,	-- Max experience that can be gained on divisional commanders
	...
	BORDER_WAR_VICTORY = 0.9,					   -- At wich border war balance of power is victory declared
	...
	COMBAT_SUPPLY_LACK_DEFENDER_DEFEND = -0.50,     -- defend combat penalty for defender if out of supply
	...
	XP_DECAY_RATE_PER_HOUR_IN_COMBAT = 0.003,				-- you get reduced XP as combat drags
...
NIndustrialOrganisation = {
	ASSIGN_DESIGN_TEAM_PP_COST_PER_DAY = 0.05,					-- Cost in Political Power daily generation when one MIO is assigned to a research slot. If 0, cost is entirely disabled.
